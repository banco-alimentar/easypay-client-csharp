...
{
    /// <summary>
    /// PropertiesHasPaymentStatus
    /// </summary>
    [DataContract(Name = "Properties_Has_PaymentStatus")]
    public partial class PropertiesHasPaymentStatus : IEquatable<PropertiesHasPaymentStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesHasPaymentStatus" /> class.
        /// </summary>
        /// <param name="paymentStatus">Status of the single payment.</param>
        public PropertiesHasPaymentStatus(string paymentStatus = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertiesHasPaymentStatus {\n");
        ...
        {
            return this.Equals(input as PropertiesHasPaymentStatus);
        }

        /// <summary>
        /// Returns true if PropertiesHasPaymentStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertiesHasPaymentStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertiesHasPaymentStatus input)
        {
            if (input == null)
                return false;
