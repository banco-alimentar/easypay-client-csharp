...
namespace Easypay.Api
{
    ...
    public interface ISinglePaymentApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Easypay.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    {
        private Easypay.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        {
            this.Configuration = Easypay.Client.Configuration.MergeConfigurations(
                Easypay.Client.GlobalConfiguration.Instance,
                new Easypay.Client.Configuration { BasePath = basePath }
            );
            this.Client = new Easypay.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new Easypay.Client.ApiClient(this.Configuration.BasePath);
            this.ExceptionFactory = Easypay.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// <returns></returns>
        public SinglePaymentApi(Easypay.Client.Configuration configuration)
        {
            ...
            this.Client = new Easypay.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new Easypay.Client.ApiClient(this.Configuration.BasePath);
            ExceptionFactory = Easypay.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        public SinglePaymentApi(Easypay.Client.ISynchronousClient client, Easypay.Client.IAsynchronousClient asyncClient, Easypay.Client.IReadableConfiguration configuration)
        {
        ...
        /// </summary>
        public Easypay.Client.IAsynchronousClient AsynchronousClient { get; set; }

        /// <summary>
        /// The client for accessing this underlying API synchronously.
        /// </summary>
        public Easypay.Client.ISynchronousClient Client { get; set; }
        ...
        public Easypay.Client.IReadableConfiguration Configuration { get; set; }

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public Easypay.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        {
            Easypay.Client.ApiResponse<PropertiesHasListMetaData> localVarResponse = SingleGetWithHttpInfo(page, recordsPerPage, type, expirationTime, method, customer, id, key, value, createdAt);
        ...
        /// <param name="createdAt">Filter by created datetime interval (max 30 days) (optional)</param>
        /// <returns>ApiResponse of PropertiesHasListMetaData</returns>
        public Easypay.Client.ApiResponse<PropertiesHasListMetaData> SingleGetWithHttpInfo(int? page = default(int?), int? recordsPerPage = default(int?), string type = default(string), string expirationTime = default(string), PaymentSingleMethodAvailable? method = default(PaymentSingleMethodAvailable?), string customer = default(string), string id = default(string), string key = default(string), double? value = default(double?), string createdAt = default(string))
        {
            Easypay.Client.RequestOptions localVarRequestOptions = new Easypay.Client.RequestOptions();
            ...
            var localVarContentType = Easypay.Client.ClientUtils.SelectHeaderContentType(_contentTypes);
            if (localVarContentType != null) localVarRequestOptions.HeaderParameters.Add("Content-Type", localVarContentType);

            var localVarAccept = Easypay.Client.ClientUtils.SelectHeaderAccept(_accepts);
            if (localVarAccept != null) localVarRequestOptions.HeaderParameters.Add("Accept", localVarAccept);

            if (page != null)
            {
                localVarRequestOptions.QueryParameters.Add(Easypay.Client.ClientUtils.ParameterToMultiMap("", "page", page));
            }
            if (recordsPerPage != null)
            {
                localVarRequestOptions.QueryParameters.Add(Easypay.Client.ClientUtils.ParameterToMultiMap("", "records_per_page", recordsPerPage));
            }
            if (type != null)
            {
                localVarRequestOptions.QueryParameters.Add(Easypay.Client.ClientUtils.ParameterToMultiMap("", "type", type));
            }
            if (expirationTime != null)
            {
                localVarRequestOptions.QueryParameters.Add(Easypay.Client.ClientUtils.ParameterToMultiMap("", "expiration_time", expirationTime));
            }
            if (method != null)
            {
                localVarRequestOptions.QueryParameters.Add(Easypay.Client.ClientUtils.ParameterToMultiMap("", "method", method));
            }
            if (customer != null)
            {
                localVarRequestOptions.QueryParameters.Add(Easypay.Client.ClientUtils.ParameterToMultiMap("", "customer", customer));
            }
            if (id != null)
            {
                localVarRequestOptions.QueryParameters.Add(Easypay.Client.ClientUtils.ParameterToMultiMap("", "id", id));
            }
            if (key != null)
            {
                localVarRequestOptions.QueryParameters.Add(Easypay.Client.ClientUtils.ParameterToMultiMap("", "key", key));
            }
            if (value != null)
            {
                localVarRequestOptions.QueryParameters.Add(Easypay.Client.ClientUtils.ParameterToMultiMap("", "value", value));
            }
            if (createdAt != null)
            {
                localVarRequestOptions.QueryParameters.Add(Easypay.Client.ClientUtils.ParameterToMultiMap("", "created_at", createdAt));
            }
        ...
        {
            Easypay.Client.ApiResponse<PropertiesHasListMetaData> localVarResponse = await SingleGetWithHttpInfoAsync(page, recordsPerPage, type, expirationTime, method, customer, id, key, value, createdAt, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PropertiesHasListMetaData)</returns>
        public async System.Threading.Tasks.Task<Easypay.Client.ApiResponse<PropertiesHasListMetaData>> SingleGetWithHttpInfoAsync(int? page = default(int?), int? recordsPerPage = default(int?), string type = default(string), string expirationTime = default(string), PaymentSingleMethodAvailable? method = default(PaymentSingleMethodAvailable?), string customer = default(string), string id = default(string), string key = default(string), double? value = default(double?), string createdAt = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
