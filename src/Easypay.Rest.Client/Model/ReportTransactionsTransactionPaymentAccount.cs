...
namespace Easypay.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Report_Transactions_Transaction_payment_account")]
    public partial class ReportTransactionsTransactionPaymentAccount : IEquatable<ReportTransactionsTransactionPaymentAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportTransactionsTransactionPaymentAccount" /> class.
        /// </summary>
        /// <param name="id">Account Uuid credited with the captured funds.</param>
        public ReportTransactionsTransactionPaymentAccount(Guid id = default(Guid))
        {
            this.Id = id;
        }

        /// <summary>
        /// Account Uuid credited with the captured funds
        /// </summary>
        /// <value>Account Uuid credited with the captured funds</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReportTransactionsTransactionPaymentAccount {\n");
        ...
        {
            return this.Equals(input as ReportTransactionsTransactionPaymentAccount);
        }

        /// <summary>
        /// Returns true if ReportTransactionsTransactionPaymentAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportTransactionsTransactionPaymentAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportTransactionsTransactionPaymentAccount input)
        {
            if (input == null)
                return false;
