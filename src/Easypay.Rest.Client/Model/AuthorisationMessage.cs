...
namespace Easypay.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Authorisation_Message")]
    public partial class AuthorisationMessage : IEquatable<AuthorisationMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorisationMessage" /> class.
        /// </summary>
        /// <param name="message">message.</param>
        public AuthorisationMessage(string message = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthorisationMessage {\n");
        ...
        {
            return this.Equals(input as AuthorisationMessage);
        }

        /// <summary>
        /// Returns true if AuthorisationMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthorisationMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthorisationMessage input)
        {
            if (input == null)
                return false;
