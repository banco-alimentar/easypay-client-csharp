...
namespace Easypay.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SinglePaymentWithTransactionsResponse")]
    public partial class SinglePaymentWithTransactionsResponse : IEquatable<SinglePaymentWithTransactionsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SinglePaymentWithTransactionsResponse" /> class.
        /// </summary>
        ...
        public SinglePaymentWithTransactionsResponse(Collection<PaymentSingleTransaction> transactions = default(Collection<PaymentSingleTransaction>), TypeEnum? type = TypeEnum.Sale, Guid id = default(Guid), string expirationTime = default(string), CurrencyEnum? currency = CurrencyEnum.EUR, SinglePaymentUpdateRequestCustomer customer = default(SinglePaymentUpdateRequestCustomer), string key = default(string), double value = default(double), PaymentSingleMethod method = default(PaymentSingleMethod), string paymentStatus = default(string), string paidAt = default(string), string createdAt = default(string))
        {
        ...
        public Collection<PaymentSingleTransaction> Transactions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SinglePaymentWithTransactionsResponse {\n");
        ...
        {
            return this.Equals(input as SinglePaymentWithTransactionsResponse);
        }

        /// <summary>
        /// Returns true if SinglePaymentWithTransactionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SinglePaymentWithTransactionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SinglePaymentWithTransactionsResponse input)
        {
            if (input == null)
                return false;
