...
{
    /// <summary>
    /// PropertiesHasCaptureNow
    /// </summary>
    [DataContract(Name = "Properties_Has_CaptureNow")]
    public partial class PropertiesHasCaptureNow : IEquatable<PropertiesHasCaptureNow>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesHasCaptureNow" /> class.
        /// </summary>
        ...
        public PropertiesHasCaptureNow(bool captureNow = false)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertiesHasCaptureNow {\n");
        ...
        {
            return this.Equals(input as PropertiesHasCaptureNow);
        }

        /// <summary>
        /// Returns true if PropertiesHasCaptureNow instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertiesHasCaptureNow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertiesHasCaptureNow input)
        {
            if (input == null)
                return false;
