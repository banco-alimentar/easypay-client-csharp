...
namespace Easypay.Rest.Client.Model
{
    ...
    public partial class CustomerDetails : IEquatable<CustomerDetails>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="CustomerDetails" /> class.
        /// </summary>
        /// <param name="name">Required if &#39;method&#39; is &#39;mbw&#39; (required).</param>
        /// <param name="email">email (required).</param>
        /// <param name="phone">Required if &#39;method&#39; is &#39;mbw&#39; (required).</param>
        ...
        public CustomerDetails(string name = default(string), string email = default(string), string phone = default(string), string phoneIndicative = "+351", string fiscalNumber = default(string), string key = default(string), string language = "PT")
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CustomerDetails and cannot be null");
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for CustomerDetails and cannot be null");
            // to ensure "phone" is required (not null)
            this.Phone = phone ?? throw new ArgumentNullException("phone is a required property for CustomerDetails and cannot be null");
