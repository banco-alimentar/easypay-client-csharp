...
namespace Easypay.Rest.Client.Model
{
    ...
    public partial class PaymentFrequentBase : IEquatable<PaymentFrequentBase>, IValidatableObject
    {
        /// <summary>
        /// Defines Currency
        /// </summary>
        ...
        public PaymentFrequentBase(string expirationTime = default(string), CurrencyEnum? currency = CurrencyEnum.EUR, Customer customer = default(Customer), string key = default(string), double maxValue = default(double), double minValue = default(double), bool unlimitedPayments = true)
        {
        ...
        {
            return this.Equals(input as PaymentFrequentBase);
        }

        /// <summary>
        /// Returns true if PaymentFrequentBase instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentFrequentBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentFrequentBase input)
        {
            if (input == null)
                return false;
