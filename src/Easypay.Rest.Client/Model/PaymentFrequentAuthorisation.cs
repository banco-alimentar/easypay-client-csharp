...
{
    /// <summary>
    /// PaymentFrequentAuthorisation
    /// </summary>
    [DataContract(Name = "Payment_Frequent_Authorisation")]
    public partial class PaymentFrequentAuthorisation : IEquatable<PaymentFrequentAuthorisation>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentFrequentAuthorisation" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="key">Merchant identification key.</param>
        /// <param name="status">status.</param>
        /// <param name="value">Value will be rounded to 2 decimals.</param>
        public PaymentFrequentAuthorisation(Guid id = default(Guid), string key = default(string), StatusEnum? status = default(StatusEnum?), double value = default(double))
        {
            this.Id = id;
            this.Key = key;
            this.Status = status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentFrequentAuthorisation {\n");
        ...
        {
            return this.Equals(input as PaymentFrequentAuthorisation);
        }

        /// <summary>
        /// Returns true if PaymentFrequentAuthorisation instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentFrequentAuthorisation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentFrequentAuthorisation input)
        {
            if (input == null)
                return false;
