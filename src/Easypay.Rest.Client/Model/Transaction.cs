...
namespace Easypay.Rest.Client.Model
{
    ...
    public partial class Transaction : IEquatable<Transaction>, IValidatableObject
    {
        ...
        public Transaction(Guid id = default(Guid), string key = default(string), string date = default(string), TransactionValues values = default(TransactionValues), string documentNumber = default(string))
        {
            this.Id = id;
            this.Key = key;
            this.Date = date;
