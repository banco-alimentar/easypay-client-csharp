...
{
    /// <summary>
    /// PaymentOutPaymentMethodStatus
    /// </summary>
    [DataContract(Name = "Payment_OutPayment_Method_Status")]
    public partial class PaymentOutPaymentMethodStatus : IEquatable<PaymentOutPaymentMethodStatus>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentOutPaymentMethodStatus" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public PaymentOutPaymentMethodStatus(StatusEnum? status = default(StatusEnum?))
        {
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentOutPaymentMethodStatus {\n");
        ...
        {
            return this.Equals(input as PaymentOutPaymentMethodStatus);
        }

        /// <summary>
        /// Returns true if PaymentOutPaymentMethodStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentOutPaymentMethodStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentOutPaymentMethodStatus input)
        {
            if (input == null)
                return false;
