...
{
    /// <summary>
    /// PaymentSubscriptionWithTransactions
    /// </summary>
    [DataContract(Name = "Payment_SubscriptionWithTransactions")]
    public partial class PaymentSubscriptionWithTransactions : IEquatable<PaymentSubscriptionWithTransactions>, IValidatableObject
    {
        /// <summary>
        /// Defines Currency
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentSubscriptionWithTransactions" /> class.
        /// </summary>
        ...
        public List<PaymentSubscriptionTransaction> Transactions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentSubscriptionWithTransactions {\n");
        ...
        {
            return this.Equals(input as PaymentSubscriptionWithTransactions);
        }

        /// <summary>
        /// Returns true if PaymentSubscriptionWithTransactions instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentSubscriptionWithTransactions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentSubscriptionWithTransactions input)
        {
            if (input == null)
                return false;
