...
namespace Easypay.Rest.Client.Model
{
    ...
    /// ResponseBulk
    /// </summary>
    [DataContract(Name = "Response_Bulk")]
    public partial class ResponseBulk : IEquatable<ResponseBulk>, IValidatableObject
    {
        /// <summary>
        ...
        public ResponseBulk(string status = default(string), List<string> message = default(List<string>), PropertiesHasID report = default(PropertiesHasID))
        {
            this.Status = status;
        ...
        {
            return this.Equals(input as ResponseBulk);
        }

        /// <summary>
        /// Returns true if ResponseBulk instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseBulk to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseBulk input)
        {
            if (input == null)
                return false;
