...
{
    /// <summary>
    /// PaymentOutPaymentTransaction
    /// </summary>
    [DataContract(Name = "Payment_OutPayment_Transaction")]
    public partial class PaymentOutPaymentTransaction : IEquatable<PaymentOutPaymentTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentOutPaymentTransaction" /> class.
        /// </summary>
        ...
        public PaymentOutPaymentTransaction(Guid id = default(Guid), string key = default(string), string date = default(string), TransactionValues values = default(TransactionValues), string documentNumber = default(string), PaymentOutPaymentMethodAvailable method = default(PaymentOutPaymentMethodAvailable), string createdAt = default(string))
        {
            this.Id = id;
            this.Key = key;
            this.Date = date;
        ...
        public PaymentOutPaymentMethodAvailable Method { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentOutPaymentTransaction {\n");
        ...
        {
            return this.Equals(input as PaymentOutPaymentTransaction);
        }

        /// <summary>
        /// Returns true if PaymentOutPaymentTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentOutPaymentTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentOutPaymentTransaction input)
        {
            if (input == null)
                return false;
