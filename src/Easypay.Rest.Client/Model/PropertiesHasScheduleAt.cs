...
{
    /// <summary>
    /// PropertiesHasScheduleAt
    /// </summary>
    [DataContract(Name = "Properties_Has_ScheduleAt")]
    public partial class PropertiesHasScheduleAt : IEquatable<PropertiesHasScheduleAt>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesHasScheduleAt" /> class.
        /// </summary>
        /// <param name="scheduleAt">Schedule date to execute the payment.</param>
        public PropertiesHasScheduleAt(string scheduleAt = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertiesHasScheduleAt {\n");
        ...
        {
            return this.Equals(input as PropertiesHasScheduleAt);
        }

        /// <summary>
        /// Returns true if PropertiesHasScheduleAt instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertiesHasScheduleAt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertiesHasScheduleAt input)
        {
            if (input == null)
                return false;
