...
{
    /// <summary>
    /// ResponseMinimalOutputFrequent
    /// </summary>
    [DataContract(Name = "Response_MinimalOutput_Frequent")]
    public partial class ResponseMinimalOutputFrequent : IEquatable<ResponseMinimalOutputFrequent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseMinimalOutputFrequent" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="method">method.</param>
        /// <param name="customer">customer.</param>
        public ResponseMinimalOutputFrequent(Guid id = default(Guid), PaymentFrequentMethodResponseMethod method = default(PaymentFrequentMethodResponseMethod), PropertiesHasID customer = default(PropertiesHasID))
        {
            this.Id = id;
            this.Method = method;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseMinimalOutputFrequent {\n");
        ...
        {
            return this.Equals(input as ResponseMinimalOutputFrequent);
        }

        /// <summary>
        /// Returns true if ResponseMinimalOutputFrequent instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseMinimalOutputFrequent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseMinimalOutputFrequent input)
        {
            if (input == null)
                return false;
