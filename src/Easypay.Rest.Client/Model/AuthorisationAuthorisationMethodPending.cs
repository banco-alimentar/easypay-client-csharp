...
{
    /// <summary>
    /// AuthorisationAuthorisationMethodPending
    /// </summary>
    [DataContract(Name = "Authorisation_AuthorisationMethod_Pending")]
    public partial class AuthorisationAuthorisationMethodPending : IEquatable<AuthorisationAuthorisationMethodPending>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorisationAuthorisationMethodPending" /> class.
        /// </summary>
        ...
        public AuthorisationAuthorisationMethodPending(int entity = default(int), string reference = default(string), string url = default(string), string lastFour = default(string), string cardType = default(string), string expirationDate = default(string), string status = default(string))
        {
            this.Entity = entity;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthorisationAuthorisationMethodPending {\n");
        ...
        {
            return this.Equals(input as AuthorisationAuthorisationMethodPending);
        }

        /// <summary>
        /// Returns true if AuthorisationAuthorisationMethodPending instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthorisationAuthorisationMethodPending to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthorisationAuthorisationMethodPending input)
        {
            if (input == null)
                return false;
