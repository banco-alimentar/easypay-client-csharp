...
{
    /// <summary>
    /// AuthorisationDetailsMethodResponseMethod
    /// </summary>
    [DataContract(Name = "Authorisation_Details_Method_Response_method")]
    public partial class AuthorisationDetailsMethodResponseMethod : IEquatable<AuthorisationDetailsMethodResponseMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorisationDetailsMethodResponseMethod" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        public AuthorisationDetailsMethodResponseMethod(AuthorisationDetailsMethodAvailable type = default(AuthorisationDetailsMethodAvailable))
        {
            this.Type = type;
        }
        ...
        public AuthorisationDetailsMethodAvailable Type { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthorisationDetailsMethodResponseMethod {\n");
        ...
        {
            return this.Equals(input as AuthorisationDetailsMethodResponseMethod);
        }

        /// <summary>
        /// Returns true if AuthorisationDetailsMethodResponseMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthorisationDetailsMethodResponseMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthorisationDetailsMethodResponseMethod input)
        {
            if (input == null)
                return false;
