...
namespace Easypay.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GenericNotificationRequest")]
    public partial class GenericNotificationRequest : IEquatable<GenericNotificationRequest>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenericNotificationRequest" /> class.
        /// </summary>
        ...
        public GenericNotificationRequest(Guid id = default(Guid), string key = default(string), TypeEnum? type = default(TypeEnum?), StatusEnum? status = default(StatusEnum?), Collection<string> messages = default(Collection<string>), string date = default(string))
        {
            this.Id = id;
            this.Key = key;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GenericNotificationRequest {\n");
        ...
        {
            return this.Equals(input as GenericNotificationRequest);
        }

        /// <summary>
        /// Returns true if GenericNotificationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GenericNotificationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenericNotificationRequest input)
        {
            if (input == null)
                return false;
