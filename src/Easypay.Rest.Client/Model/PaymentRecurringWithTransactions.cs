...
{
    /// <summary>
    /// PaymentRecurringWithTransactions
    /// </summary>
    [DataContract(Name = "Payment_RecurringWithTransactions")]
    public partial class PaymentRecurringWithTransactions : IEquatable<PaymentRecurringWithTransactions>, IValidatableObject
    {
        /// <summary>
        /// Defines Currency
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRecurringWithTransactions" /> class.
        /// </summary>
        ...
        public List<PaymentRecurringTransaction> Transactions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentRecurringWithTransactions {\n");
        ...
        {
            return this.Equals(input as PaymentRecurringWithTransactions);
        }

        /// <summary>
        /// Returns true if PaymentRecurringWithTransactions instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRecurringWithTransactions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRecurringWithTransactions input)
        {
            if (input == null)
                return false;
