...
{
    /// <summary>
    /// PropertiesHasFailover
    /// </summary>
    [DataContract(Name = "Properties_Has_Failover")]
    public partial class PropertiesHasFailover : IEquatable<PropertiesHasFailover>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesHasFailover" /> class.
        /// </summary>
        ...
        public PropertiesHasFailover(bool failover = false)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertiesHasFailover {\n");
        ...
        {
            return this.Equals(input as PropertiesHasFailover);
        }

        /// <summary>
        /// Returns true if PropertiesHasFailover instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertiesHasFailover to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertiesHasFailover input)
        {
            if (input == null)
                return false;
