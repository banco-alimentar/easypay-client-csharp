...
{
    /// <summary>
    /// PaymentMethodPropertiesStatusPending
    /// </summary>
    [DataContract(Name = "PaymentMethod_Properties_Status_Pending")]
    public partial class PaymentMethodPropertiesStatusPending : IEquatable<PaymentMethodPropertiesStatusPending>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentMethodPropertiesStatusPending" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public PaymentMethodPropertiesStatusPending(string status = default(string))
        {
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentMethodPropertiesStatusPending {\n");
        ...
        {
            return this.Equals(input as PaymentMethodPropertiesStatusPending);
        }

        /// <summary>
        /// Returns true if PaymentMethodPropertiesStatusPending instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentMethodPropertiesStatusPending to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentMethodPropertiesStatusPending input)
        {
            if (input == null)
                return false;
