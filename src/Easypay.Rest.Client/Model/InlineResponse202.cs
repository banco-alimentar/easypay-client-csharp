...
namespace Easypay.Rest.Client.Model
{
    ...
    public partial class InlineResponse202 : IEquatable<InlineResponse202>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="propertiesHasReportID">propertiesHasReportID.</param>
        /// <param name="statusDetails">statusDetails.</param>
        public InlineResponse202(PropertiesHasReportID propertiesHasReportID = default(PropertiesHasReportID), StatusDetails statusDetails = default(StatusDetails))
        {
            this.PropertiesHasReportID = propertiesHasReportID;
            this.StatusDetails = statusDetails;
        }

        /// <summary>
        /// Gets or Sets PropertiesHasReportID
        /// </summary>
        [DataMember(Name = "Properties_Has_ReportID", EmitDefaultValue = false)]
        public PropertiesHasReportID PropertiesHasReportID { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PropertiesHasReportID: ").Append(PropertiesHasReportID).Append("\n");
        ...
        public bool Equals(InlineResponse202 input)
        {
            ...
            return 
                (
                    this.PropertiesHasReportID == input.PropertiesHasReportID ||
                    (this.PropertiesHasReportID != null &&
                    this.PropertiesHasReportID.Equals(input.PropertiesHasReportID))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.PropertiesHasReportID != null)
                    hashCode = hashCode * 59 + this.PropertiesHasReportID.GetHashCode();
