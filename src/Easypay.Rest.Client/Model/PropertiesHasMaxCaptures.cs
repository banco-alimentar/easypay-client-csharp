...
{
    /// <summary>
    /// PropertiesHasMaxCaptures
    /// </summary>
    [DataContract(Name = "Properties_Has_MaxCaptures")]
    public partial class PropertiesHasMaxCaptures : IEquatable<PropertiesHasMaxCaptures>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesHasMaxCaptures" /> class.
        /// </summary>
        /// <param name="maxCaptures">Required only when no expiration_time is set.</param>
        public PropertiesHasMaxCaptures(decimal maxCaptures = default(decimal))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertiesHasMaxCaptures {\n");
        ...
        {
            return this.Equals(input as PropertiesHasMaxCaptures);
        }

        /// <summary>
        /// Returns true if PropertiesHasMaxCaptures instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertiesHasMaxCaptures to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertiesHasMaxCaptures input)
        {
            if (input == null)
                return false;
