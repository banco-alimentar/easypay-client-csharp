...
{
    /// <summary>
    /// AuthorisationAuthorisationMethodPropertiesStatusPending
    /// </summary>
    [DataContract(Name = "Authorisation_AuthorisationMethod_Properties_Status_Pending")]
    public partial class AuthorisationAuthorisationMethodPropertiesStatusPending : IEquatable<AuthorisationAuthorisationMethodPropertiesStatusPending>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorisationAuthorisationMethodPropertiesStatusPending" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public AuthorisationAuthorisationMethodPropertiesStatusPending(string status = default(string))
        {
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthorisationAuthorisationMethodPropertiesStatusPending {\n");
        ...
        {
            return this.Equals(input as AuthorisationAuthorisationMethodPropertiesStatusPending);
        }

        /// <summary>
        /// Returns true if AuthorisationAuthorisationMethodPropertiesStatusPending instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthorisationAuthorisationMethodPropertiesStatusPending to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthorisationAuthorisationMethodPropertiesStatusPending input)
        {
            if (input == null)
                return false;
