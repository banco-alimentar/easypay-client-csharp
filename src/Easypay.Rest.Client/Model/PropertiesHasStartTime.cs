...
{
    /// <summary>
    /// PropertiesHasStartTime
    /// </summary>
    [DataContract(Name = "Properties_Has_StartTime")]
    public partial class PropertiesHasStartTime : IEquatable<PropertiesHasStartTime>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesHasStartTime" /> class.
        /// </summary>
        /// <param name="startTime">Date to start the billing cycles.</param>
        public PropertiesHasStartTime(string startTime = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertiesHasStartTime {\n");
        ...
        {
            return this.Equals(input as PropertiesHasStartTime);
        }

        /// <summary>
        /// Returns true if PropertiesHasStartTime instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertiesHasStartTime to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertiesHasStartTime input)
        {
            if (input == null)
                return false;
