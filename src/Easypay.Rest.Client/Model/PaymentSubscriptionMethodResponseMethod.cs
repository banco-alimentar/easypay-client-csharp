...
{
    /// <summary>
    /// PaymentSubscriptionMethodResponseMethod
    /// </summary>
    [DataContract(Name = "Payment_Subscription_Method_Response_method")]
    public partial class PaymentSubscriptionMethodResponseMethod : IEquatable<PaymentSubscriptionMethodResponseMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentSubscriptionMethodResponseMethod" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="sddMandate">sddMandate.</param>
        public PaymentSubscriptionMethodResponseMethod(PaymentSubscriptionMethodAvailable type = default(PaymentSubscriptionMethodAvailable), SddMandate sddMandate = default(SddMandate))
        {
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentSubscriptionMethodResponseMethod {\n");
        ...
        {
            return this.Equals(input as PaymentSubscriptionMethodResponseMethod);
        }

        /// <summary>
        /// Returns true if PaymentSubscriptionMethodResponseMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentSubscriptionMethodResponseMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentSubscriptionMethodResponseMethod input)
        {
            if (input == null)
                return false;
