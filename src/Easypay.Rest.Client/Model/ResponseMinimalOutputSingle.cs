...
{
    /// <summary>
    /// ResponseMinimalOutputSingle
    /// </summary>
    [DataContract(Name = "Response_MinimalOutput_Single")]
    public partial class ResponseMinimalOutputSingle : IEquatable<ResponseMinimalOutputSingle>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseMinimalOutputSingle" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="method">method.</param>
        /// <param name="customer">customer.</param>
        public ResponseMinimalOutputSingle(Guid id = default(Guid), PaymentSingleMethodResponseMethod method = default(PaymentSingleMethodResponseMethod), PropertiesHasID customer = default(PropertiesHasID))
        {
            this.Id = id;
            this.Method = method;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseMinimalOutputSingle {\n");
        ...
        {
            return this.Equals(input as ResponseMinimalOutputSingle);
        }

        /// <summary>
        /// Returns true if ResponseMinimalOutputSingle instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseMinimalOutputSingle to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseMinimalOutputSingle input)
        {
            if (input == null)
                return false;
