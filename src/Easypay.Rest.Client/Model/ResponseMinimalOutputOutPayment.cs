...
{
    /// <summary>
    /// ResponseMinimalOutputOutPayment
    /// </summary>
    [DataContract(Name = "Response_MinimalOutput_OutPayment")]
    public partial class ResponseMinimalOutputOutPayment : IEquatable<ResponseMinimalOutputOutPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseMinimalOutputOutPayment" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="outAccount">outAccount.</param>
        /// <param name="customer">customer.</param>
        public ResponseMinimalOutputOutPayment(Guid id = default(Guid), PropertiesHasID outAccount = default(PropertiesHasID), PropertiesHasID customer = default(PropertiesHasID))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseMinimalOutputOutPayment {\n");
        ...
        {
            return this.Equals(input as ResponseMinimalOutputOutPayment);
        }

        /// <summary>
        /// Returns true if ResponseMinimalOutputOutPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseMinimalOutputOutPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseMinimalOutputOutPayment input)
        {
            if (input == null)
                return false;
