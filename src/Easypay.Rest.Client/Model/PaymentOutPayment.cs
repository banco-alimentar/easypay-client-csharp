...
namespace Easypay.Rest.Client.Model
{
    ...
    /// PaymentOutPayment
    /// </summary>
    [DataContract(Name = "Payment_OutPayment")]
    public partial class PaymentOutPayment : IEquatable<PaymentOutPayment>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentOutPayment" /> class.
        /// </summary>
        ...
        public PaymentOutPayment(Guid id = default(Guid), Customer customer = default(Customer), string key = default(string), double value = default(double), TypeEnum? type = TypeEnum.Normal, string scheduleAt = default(string), PropertiesHasID account = default(PropertiesHasID), PropertiesHasID outAccount = default(PropertiesHasID))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentOutPayment {\n");
        ...
        {
            return this.Equals(input as PaymentOutPayment);
        }

        /// <summary>
        /// Returns true if PaymentOutPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentOutPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentOutPayment input)
        {
            if (input == null)
                return false;
