...
namespace Easypay.Rest.Client.Model
{
    ...
    /// CheckoutManifest
    /// </summary>
    [DataContract(Name = "Checkout_Manifest")]
    public partial class CheckoutManifest : IEquatable<CheckoutManifest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckoutManifest" /> class.
        /// </summary>
        /// <param name="session">JWT.</param>
        /// <param name="config">UI configurations.</param>
        /// <param name="id">id.</param>
        public CheckoutManifest(string session = default(string), List<string> config = default(List<string>), Guid id = default(Guid))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CheckoutManifest {\n");
        ...
        {
            return this.Equals(input as CheckoutManifest);
        }

        /// <summary>
        /// Returns true if CheckoutManifest instances are equal
        /// </summary>
        /// <param name="input">Instance of CheckoutManifest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckoutManifest input)
        {
            if (input == null)
                return false;
