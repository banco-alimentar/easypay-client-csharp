...
namespace Easypay.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountConfigRequest")]
    public partial class AccountConfigRequest : IEquatable<AccountConfigRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountConfigRequest" /> class.
        /// </summary>
        ...
        public AccountConfigRequest(string generic = "https://www.easypay.pt/generic", string authorisation = "https://www.easypay.pt/authorisation", string transaction = "https://www.easypay.pt/transaction", string visaFwd = "https://www.easypay.pt/visa_fwd", string visaDetail = "https://www.easypay.pt/visa_detail")
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountConfigRequest {\n");
        ...
        {
            return this.Equals(input as AccountConfigRequest);
        }

        /// <summary>
        /// Returns true if AccountConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountConfigRequest input)
        {
            if (input == null)
                return false;
