...
{
    /// <summary>
    /// PropertiesHasReportID
    /// </summary>
    [DataContract(Name = "Properties_Has_ReportID")]
    public partial class PropertiesHasReportID : IEquatable<PropertiesHasReportID>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesHasReportID" /> class.
        /// </summary>
        /// <param name="report">report.</param>
        public PropertiesHasReportID(PropertiesHasID report = default(PropertiesHasID))
        {
            this.Report = report;
        }
        ...
        public PropertiesHasID Report { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertiesHasReportID {\n");
        ...
        {
            return this.Equals(input as PropertiesHasReportID);
        }

        /// <summary>
        /// Returns true if PropertiesHasReportID instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertiesHasReportID to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertiesHasReportID input)
        {
            if (input == null)
                return false;
