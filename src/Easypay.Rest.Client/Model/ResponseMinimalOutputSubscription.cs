...
{
    /// <summary>
    /// ResponseMinimalOutputSubscription
    /// </summary>
    [DataContract(Name = "Response_MinimalOutput_Subscription")]
    public partial class ResponseMinimalOutputSubscription : IEquatable<ResponseMinimalOutputSubscription>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseMinimalOutputSubscription" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="method">method.</param>
        /// <param name="customer">customer.</param>
        public ResponseMinimalOutputSubscription(Guid id = default(Guid), PaymentSubscriptionMethodResponseMethod method = default(PaymentSubscriptionMethodResponseMethod), PropertiesHasID customer = default(PropertiesHasID))
        {
            this.Id = id;
            this.Method = method;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseMinimalOutputSubscription {\n");
        ...
        {
            return this.Equals(input as ResponseMinimalOutputSubscription);
        }

        /// <summary>
        /// Returns true if ResponseMinimalOutputSubscription instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseMinimalOutputSubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseMinimalOutputSubscription input)
        {
            if (input == null)
                return false;
