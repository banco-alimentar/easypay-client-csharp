...
{
    /// <summary>
    /// AuthorisationAuthorisationMethodBase
    /// </summary>
    [DataContract(Name = "Authorisation_AuthorisationMethod_Base")]
    public partial class AuthorisationAuthorisationMethodBase : IEquatable<AuthorisationAuthorisationMethodBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorisationAuthorisationMethodBase" /> class.
        /// </summary>
        ...
        public AuthorisationAuthorisationMethodBase(int entity = default(int), string reference = default(string), string url = default(string), string lastFour = default(string), string cardType = default(string), string expirationDate = default(string))
        {
            this.Entity = entity;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthorisationAuthorisationMethodBase {\n");
        ...
        {
            return this.Equals(input as AuthorisationAuthorisationMethodBase);
        }

        /// <summary>
        /// Returns true if AuthorisationAuthorisationMethodBase instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthorisationAuthorisationMethodBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthorisationAuthorisationMethodBase input)
        {
            if (input == null)
                return false;
