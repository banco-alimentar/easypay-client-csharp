...
namespace Easypay.Rest.Client.Model
{
    ...
    public partial class InlineResponse2013 : IEquatable<InlineResponse2013>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="responseMinimalOutputSingle">responseMinimalOutputSingle.</param>
        /// <param name="statusDetails">statusDetails.</param>
        public InlineResponse2013(ResponseMinimalOutputSingle responseMinimalOutputSingle = default(ResponseMinimalOutputSingle), StatusDetails statusDetails = default(StatusDetails))
        {
            this.ResponseMinimalOutputSingle = responseMinimalOutputSingle;
            this.StatusDetails = statusDetails;
        }

        /// <summary>
        /// Gets or Sets ResponseMinimalOutputSingle
        /// </summary>
        [DataMember(Name = "Response_MinimalOutput_Single", EmitDefaultValue = false)]
        public ResponseMinimalOutputSingle ResponseMinimalOutputSingle { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ResponseMinimalOutputSingle: ").Append(ResponseMinimalOutputSingle).Append("\n");
        ...
        public bool Equals(InlineResponse2013 input)
        {
            ...
            return 
                (
                    this.ResponseMinimalOutputSingle == input.ResponseMinimalOutputSingle ||
                    (this.ResponseMinimalOutputSingle != null &&
                    this.ResponseMinimalOutputSingle.Equals(input.ResponseMinimalOutputSingle))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ResponseMinimalOutputSingle != null)
                    hashCode = hashCode * 59 + this.ResponseMinimalOutputSingle.GetHashCode();
