...
{
    /// <summary>
    /// AuthorisationDetailsMethodResponse
    /// </summary>
    [DataContract(Name = "Authorisation_Details_Method_Response")]
    public partial class AuthorisationDetailsMethodResponse : IEquatable<AuthorisationDetailsMethodResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorisationDetailsMethodResponse" /> class.
        /// </summary>
        /// <param name="method">method.</param>
        public AuthorisationDetailsMethodResponse(AuthorisationDetailsMethodResponseMethod method = default(AuthorisationDetailsMethodResponseMethod))
        {
            this.Method = method;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthorisationDetailsMethodResponse {\n");
        ...
        {
            return this.Equals(input as AuthorisationDetailsMethodResponse);
        }

        /// <summary>
        /// Returns true if AuthorisationDetailsMethodResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthorisationDetailsMethodResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthorisationDetailsMethodResponse input)
        {
            if (input == null)
                return false;
