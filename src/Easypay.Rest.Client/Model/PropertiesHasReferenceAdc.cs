...
namespace Easypay.Rest.Client.Model
{
    ...
    public partial class PropertiesHasReferenceAdc : IEquatable<PropertiesHasReferenceAdc>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PropertiesHasReferenceAdc);
        }

        /// <summary>
        /// Returns true if PropertiesHasReferenceAdc instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertiesHasReferenceAdc to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertiesHasReferenceAdc input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ReferenceAdc == input.ReferenceAdc ||
                    (this.ReferenceAdc != null &&
                    this.ReferenceAdc.Equals(input.ReferenceAdc))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ReferenceAdc != null)
                    hashCode = hashCode * 59 + this.ReferenceAdc.GetHashCode();
                return hashCode;
            }
        }
