...
{
    /// <summary>
    /// PaymentRecurringMethodResponse
    /// </summary>
    [DataContract(Name = "Payment_Recurring_Method_Response")]
    public partial class PaymentRecurringMethodResponse : IEquatable<PaymentRecurringMethodResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRecurringMethodResponse" /> class.
        /// </summary>
        /// <param name="method">method.</param>
        public PaymentRecurringMethodResponse(PaymentRecurringMethodResponseMethod method = default(PaymentRecurringMethodResponseMethod))
        {
            this.Method = method;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentRecurringMethodResponse {\n");
        ...
        {
            return this.Equals(input as PaymentRecurringMethodResponse);
        }

        /// <summary>
        /// Returns true if PaymentRecurringMethodResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRecurringMethodResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRecurringMethodResponse input)
        {
            if (input == null)
                return false;
