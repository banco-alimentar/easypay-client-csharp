...
{
    /// <summary>
    /// PaymentSubscriptionMethodResponse
    /// </summary>
    [DataContract(Name = "Payment_Subscription_Method_Response")]
    public partial class PaymentSubscriptionMethodResponse : IEquatable<PaymentSubscriptionMethodResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentSubscriptionMethodResponse" /> class.
        /// </summary>
        /// <param name="method">method.</param>
        public PaymentSubscriptionMethodResponse(PaymentSubscriptionMethodResponseMethod method = default(PaymentSubscriptionMethodResponseMethod))
        {
            this.Method = method;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentSubscriptionMethodResponse {\n");
        ...
        {
            return this.Equals(input as PaymentSubscriptionMethodResponse);
        }

        /// <summary>
        /// Returns true if PaymentSubscriptionMethodResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentSubscriptionMethodResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentSubscriptionMethodResponse input)
        {
            if (input == null)
                return false;
