...
namespace Easypay.Rest.Client.Model
{
    ...
    public partial class InlineResponse2004 : IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="paymentSubscription">paymentSubscription.</param>
        /// <param name="statusDetails">statusDetails.</param>
        public InlineResponse2004(PaymentSubscription paymentSubscription = default(PaymentSubscription), StatusDetails statusDetails = default(StatusDetails))
        {
        ...
        /// <summary>
        /// Gets or Sets PaymentSubscription
        /// </summary>
        [DataMember(Name = "Payment_Subscription", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PaymentSubscription: ").Append(PaymentSubscription).Append("\n");
        ...
        public bool Equals(InlineResponse2004 input)
        {
            ...
            return 
                (
                    this.PaymentSubscription == input.PaymentSubscription ||
                    (this.PaymentSubscription != null &&
                    this.PaymentSubscription.Equals(input.PaymentSubscription))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PaymentSubscription != null)
                    hashCode = hashCode * 59 + this.PaymentSubscription.GetHashCode();
