...
{
    /// <summary>
    /// PropertiesHasTimestamp
    /// </summary>
    [DataContract(Name = "Properties_Has_Timestamp")]
    public partial class PropertiesHasTimestamp : IEquatable<PropertiesHasTimestamp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesHasTimestamp" /> class.
        /// </summary>
        /// <param name="timestamp">Unix timestamp UTC, must be no more than 1 minute before or after real time, if not the strong authentication signature will not be valid.</param>
        public PropertiesHasTimestamp(string timestamp = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertiesHasTimestamp {\n");
        ...
        {
            return this.Equals(input as PropertiesHasTimestamp);
        }

        /// <summary>
        /// Returns true if PropertiesHasTimestamp instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertiesHasTimestamp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertiesHasTimestamp input)
        {
            if (input == null)
                return false;
