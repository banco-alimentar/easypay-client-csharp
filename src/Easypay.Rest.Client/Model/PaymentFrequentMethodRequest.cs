...
{
    /// <summary>
    /// PaymentFrequentMethodRequest
    /// </summary>
    [DataContract(Name = "Payment_Frequent_Method_Request")]
    public partial class PaymentFrequentMethodRequest : IEquatable<PaymentFrequentMethodRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentFrequentMethodRequest" /> class.
        /// </summary>
        /// <param name="method">method.</param>
        public PaymentFrequentMethodRequest(PaymentFrequentMethodAvailable method = default(PaymentFrequentMethodAvailable))
        {
            this.Method = method;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentFrequentMethodRequest {\n");
        ...
        {
            return this.Equals(input as PaymentFrequentMethodRequest);
        }

        /// <summary>
        /// Returns true if PaymentFrequentMethodRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentFrequentMethodRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentFrequentMethodRequest input)
        {
            if (input == null)
                return false;
