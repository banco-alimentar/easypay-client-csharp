...
{
    /// <summary>
    /// ReportDetailsFullPayment
    /// </summary>
    [DataContract(Name = "Report_DetailsFull_payment")]
    public partial class ReportDetailsFullPayment : IEquatable<ReportDetailsFullPayment>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Subcription for value: subcription
            /// </summary>
            [EnumMember(Value = "subcription")]
            Subcription = 3
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportDetailsFullPayment" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        public ReportDetailsFullPayment(TypeEnum? type = default(TypeEnum?))
        {
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReportDetailsFullPayment {\n");
        ...
        {
            return this.Equals(input as ReportDetailsFullPayment);
        }

        /// <summary>
        /// Returns true if ReportDetailsFullPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportDetailsFullPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportDetailsFullPayment input)
        {
            if (input == null)
                return false;
