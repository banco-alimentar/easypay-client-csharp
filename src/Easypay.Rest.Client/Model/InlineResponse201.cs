...
namespace Easypay.Rest.Client.Model
{
    ...
    public partial class InlineResponse201 : IEquatable<InlineResponse201>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="responseMinimalOutputFrequent">responseMinimalOutputFrequent.</param>
        /// <param name="statusDetails">statusDetails.</param>
        public InlineResponse201(ResponseMinimalOutputFrequent responseMinimalOutputFrequent = default(ResponseMinimalOutputFrequent), StatusDetails statusDetails = default(StatusDetails))
        {
            this.ResponseMinimalOutputFrequent = responseMinimalOutputFrequent;
            this.StatusDetails = statusDetails;
        }

        /// <summary>
        /// Gets or Sets ResponseMinimalOutputFrequent
        /// </summary>
        [DataMember(Name = "Response_MinimalOutput_Frequent", EmitDefaultValue = false)]
        public ResponseMinimalOutputFrequent ResponseMinimalOutputFrequent { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ResponseMinimalOutputFrequent: ").Append(ResponseMinimalOutputFrequent).Append("\n");
        ...
        public bool Equals(InlineResponse201 input)
        {
            ...
            return 
                (
                    this.ResponseMinimalOutputFrequent == input.ResponseMinimalOutputFrequent ||
                    (this.ResponseMinimalOutputFrequent != null &&
                    this.ResponseMinimalOutputFrequent.Equals(input.ResponseMinimalOutputFrequent))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ResponseMinimalOutputFrequent != null)
                    hashCode = hashCode * 59 + this.ResponseMinimalOutputFrequent.GetHashCode();
