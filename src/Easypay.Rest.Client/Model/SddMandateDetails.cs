...
namespace Easypay.Rest.Client.Model
{
    ...
    /// SddMandateDetails
    /// </summary>
    [DataContract(Name = "SddMandate_Details")]
    public partial class SddMandateDetails : IEquatable<SddMandateDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SddMandateDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SddMandateDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SddMandateDetails" /> class.
        /// </summary>
        ...
        public SddMandateDetails(string iban = default(string), string key = default(string), string name = default(string), string email = default(string), string phone = default(string), string accountHolder = default(string), string countryCode = default(string), string maxNumDebits = default(string))
        {
            // to ensure "iban" is required (not null)
            this.Iban = iban ?? throw new ArgumentNullException("iban is a required property for SddMandateDetails and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for SddMandateDetails and cannot be null");
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for SddMandateDetails and cannot be null");
            // to ensure "phone" is required (not null)
            this.Phone = phone ?? throw new ArgumentNullException("phone is a required property for SddMandateDetails and cannot be null");
            // to ensure "accountHolder" is required (not null)
            this.AccountHolder = accountHolder ?? throw new ArgumentNullException("accountHolder is a required property for SddMandateDetails and cannot be null");
            this.Key = key;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SddMandateDetails {\n");
        ...
        {
            return this.Equals(input as SddMandateDetails);
        }

        /// <summary>
        /// Returns true if SddMandateDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of SddMandateDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SddMandateDetails input)
        {
            if (input == null)
                return false;
