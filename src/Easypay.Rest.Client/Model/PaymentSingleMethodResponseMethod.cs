...
{
    /// <summary>
    /// PaymentSingleMethodResponseMethod
    /// </summary>
    [DataContract(Name = "Payment_Single_Method_Response_method")]
    public partial class PaymentSingleMethodResponseMethod : IEquatable<PaymentSingleMethodResponseMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentSingleMethodResponseMethod" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="sddMandate">sddMandate.</param>
        public PaymentSingleMethodResponseMethod(PaymentSingleMethodAvailable type = default(PaymentSingleMethodAvailable), SddMandate sddMandate = default(SddMandate))
        {
            this.Type = type;
        ...
        public PaymentSingleMethodAvailable Type { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentSingleMethodResponseMethod {\n");
        ...
        {
            return this.Equals(input as PaymentSingleMethodResponseMethod);
        }

        /// <summary>
        /// Returns true if PaymentSingleMethodResponseMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentSingleMethodResponseMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentSingleMethodResponseMethod input)
        {
            if (input == null)
                return false;
