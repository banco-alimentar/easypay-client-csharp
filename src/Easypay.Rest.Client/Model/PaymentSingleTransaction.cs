...
namespace Easypay.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Payment_Single_Transaction")]
    public partial class PaymentSingleTransaction : IEquatable<PaymentSingleTransaction>, IValidatableObject
    {
        /// <summary>
        /// Defines Method
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentSingleTransaction" /> class.
        /// </summary>
        ...
        public PaymentSingleTransaction(Guid id = default(Guid), string key = default(string), string date = default(string), PaymentSingleTransactionValues values = default(PaymentSingleTransactionValues), DateTime transferDate = default(DateTime), string documentNumber = default(string), MethodEnum? method = default(MethodEnum?), string descriptive = default(string))
        {
            this.Id = id;
            this.Key = key;
            this.Date = date;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentSingleTransaction {\n");
        ...
        {
            return this.Equals(input as PaymentSingleTransaction);
        }

        /// <summary>
        /// Returns true if PaymentSingleTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentSingleTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentSingleTransaction input)
        {
            if (input == null)
                return false;
