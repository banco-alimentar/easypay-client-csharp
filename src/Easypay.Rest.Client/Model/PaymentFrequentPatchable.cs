...
{
    /// <summary>
    /// PaymentFrequentPatchable
    /// </summary>
    [DataContract(Name = "Payment_Frequent_Patchable")]
    public partial class PaymentFrequentPatchable : IEquatable<PaymentFrequentPatchable>, IValidatableObject
    {
        /// <summary>
        /// Only available to change between active and deleted
        /// </summary>
        /// <value>Only available to change between active and deleted</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentFrequentPatchable" /> class.
        /// </summary>
        /// <param name="status">Only available to change between active and deleted.</param>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentFrequentPatchable {\n");
        ...
        {
            return this.Equals(input as PaymentFrequentPatchable);
        }

        /// <summary>
        /// Returns true if PaymentFrequentPatchable instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentFrequentPatchable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentFrequentPatchable input)
        {
            if (input == null)
                return false;
