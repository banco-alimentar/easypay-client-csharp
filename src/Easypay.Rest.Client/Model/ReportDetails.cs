...
namespace Easypay.Rest.Client.Model
{
    ...
    /// ReportDetails
    /// </summary>
    [DataContract(Name = "Report_Details")]
    public partial class ReportDetails : IEquatable<ReportDetails>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportDetails" /> class.
        /// </summary>
        ...
        public ReportDetails(TypeEnum? type = default(TypeEnum?), Object dateRange = default(Object), string operation = default(string), Object payment = default(Object), PropertiesHasID account = default(PropertiesHasID), PropertiesHasID customer = default(PropertiesHasID))
        {
            this.Type = type;
        ...
        {
            return this.Equals(input as ReportDetails);
        }

        /// <summary>
        /// Returns true if ReportDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportDetails input)
        {
            if (input == null)
                return false;
