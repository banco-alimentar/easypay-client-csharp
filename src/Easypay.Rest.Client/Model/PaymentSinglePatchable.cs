...
{
    /// <summary>
    /// PaymentSinglePatchable
    /// </summary>
    [DataContract(Name = "Payment_Single_Patchable")]
    public partial class PaymentSinglePatchable : IEquatable<PaymentSinglePatchable>, IValidatableObject
    {
        /// <summary>
        /// Defines Currency
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentSinglePatchable" /> class.
        /// </summary>
        ...
        public PaymentSinglePatchable(string expirationTime = default(string), CurrencyEnum? currency = CurrencyEnum.EUR, Customer customer = default(Customer), string key = default(string), double value = default(double), TypeEnum? type = TypeEnum.Sale, PaymentSingleMethodAvailable method = default(PaymentSingleMethodAvailable), PropertiesHasID account = default(PropertiesHasID), SddMandate sddMandate = default(SddMandate))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentSinglePatchable {\n");
        ...
        {
            return this.Equals(input as PaymentSinglePatchable);
        }

        /// <summary>
        /// Returns true if PaymentSinglePatchable instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentSinglePatchable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentSinglePatchable input)
        {
            if (input == null)
                return false;
