...
{
    /// <summary>
    /// PaymentOutPaymentMethodResponse
    /// </summary>
    [DataContract(Name = "Payment_OutPayment_Method_Response")]
    public partial class PaymentOutPaymentMethodResponse : IEquatable<PaymentOutPaymentMethodResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentOutPaymentMethodResponse" /> class.
        /// </summary>
        /// <param name="method">method.</param>
        /// <param name="outAccount">outAccount.</param>
        public PaymentOutPaymentMethodResponse(Object method = default(Object), PropertiesHasID outAccount = default(PropertiesHasID))
        {
            this.Method = method;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentOutPaymentMethodResponse {\n");
        ...
        {
            return this.Equals(input as PaymentOutPaymentMethodResponse);
        }

        /// <summary>
        /// Returns true if PaymentOutPaymentMethodResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentOutPaymentMethodResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentOutPaymentMethodResponse input)
        {
            if (input == null)
                return false;
