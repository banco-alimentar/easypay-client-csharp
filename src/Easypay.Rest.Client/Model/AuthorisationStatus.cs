...
namespace Easypay.Rest.Client.Model
{
    ...
    /// AuthorisationStatus
    /// </summary>
    [DataContract(Name = "Authorisation_Status")]
    public partial class AuthorisationStatus : IEquatable<AuthorisationStatus>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorisationStatus" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public AuthorisationStatus(StatusEnum? status = default(StatusEnum?))
        {
            this.Status = status;
        }
        ...
        {
            return this.Equals(input as AuthorisationStatus);
        }

        /// <summary>
        /// Returns true if AuthorisationStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthorisationStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthorisationStatus input)
        {
            if (input == null)
                return false;
