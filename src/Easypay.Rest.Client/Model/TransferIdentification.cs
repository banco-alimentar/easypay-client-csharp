...
namespace Easypay.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Transfer_Identification")]
    public partial class TransferIdentification : IEquatable<TransferIdentification>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferIdentification" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="status">status.</param>
        public TransferIdentification(Guid id = default(Guid), StatusEnum? status = default(StatusEnum?))
        {
            this.Id = id;
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransferIdentification {\n");
        ...
        {
            return this.Equals(input as TransferIdentification);
        }

        /// <summary>
        /// Returns true if TransferIdentification instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferIdentification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferIdentification input)
        {
            if (input == null)
                return false;
