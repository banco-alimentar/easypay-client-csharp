...
namespace Easypay.Rest.Client.Model
{
    ...
    public partial class PropertiesHasAuthorisationID : IEquatable<PropertiesHasAuthorisationID>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PropertiesHasAuthorisationID);
        }

        /// <summary>
        /// Returns true if PropertiesHasAuthorisationID instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertiesHasAuthorisationID to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertiesHasAuthorisationID input)
        {
            if (input == null)
                return false;
