...
{
    /// <summary>
    /// PaymentRecurringMethodResponseMethod
    /// </summary>
    [DataContract(Name = "Payment_Recurring_Method_Response_method")]
    public partial class PaymentRecurringMethodResponseMethod : IEquatable<PaymentRecurringMethodResponseMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRecurringMethodResponseMethod" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        public PaymentRecurringMethodResponseMethod(PaymentRecurringMethodAvailable type = default(PaymentRecurringMethodAvailable))
        {
            this.Type = type;
        }
        ...
        public PaymentRecurringMethodAvailable Type { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentRecurringMethodResponseMethod {\n");
        ...
        {
            return this.Equals(input as PaymentRecurringMethodResponseMethod);
        }

        /// <summary>
        /// Returns true if PaymentRecurringMethodResponseMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRecurringMethodResponseMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRecurringMethodResponseMethod input)
        {
            if (input == null)
                return false;
