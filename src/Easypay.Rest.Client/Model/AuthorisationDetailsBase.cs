...
{
    /// <summary>
    /// AuthorisationDetailsBase
    /// </summary>
    [DataContract(Name = "Authorisation_Details_Base")]
    public partial class AuthorisationDetailsBase : IEquatable<AuthorisationDetailsBase>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorisationDetailsBase" /> class.
        /// </summary>
        ...
        public AuthorisationDetailsBase(StatusEnum? status = default(StatusEnum?), string message = default(string), CurrencyEnum? currency = CurrencyEnum.EUR, Customer customer = default(Customer), string key = default(string), double value = default(double), double valueCaptured = default(double))
        {
            this.Status = status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthorisationDetailsBase {\n");
        ...
        {
            return this.Equals(input as AuthorisationDetailsBase);
        }

        /// <summary>
        /// Returns true if AuthorisationDetailsBase instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthorisationDetailsBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthorisationDetailsBase input)
        {
            if (input == null)
                return false;
