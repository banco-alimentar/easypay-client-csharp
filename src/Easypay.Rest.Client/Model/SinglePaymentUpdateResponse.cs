...
namespace Easypay.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SinglePaymentUpdateResponse")]
    public partial class SinglePaymentUpdateResponse : IEquatable<SinglePaymentUpdateResponse>, IValidatableObject
    {
        /// <summary>
        /// Defines Currency
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SinglePaymentUpdateResponse" /> class.
        /// </summary>
        ...
        public SinglePaymentUpdateResponse(string status = default(string), Collection<string> message = default(Collection<string>), Guid id = default(Guid), string expirationTime = default(string), CurrencyEnum? currency = CurrencyEnum.EUR, Customer customer = default(Customer), string key = default(string), double value = default(double), TypeEnum? type = TypeEnum.Sale, UpdatedSinglePaymentMethod method = default(UpdatedSinglePaymentMethod), string paymentStatus = default(string), string paidAt = default(string), string createdAt = default(string))
        {
            this.Status = status;
        ...
        public UpdatedSinglePaymentMethod Method { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SinglePaymentUpdateResponse {\n");
        ...
        {
            return this.Equals(input as SinglePaymentUpdateResponse);
        }

        /// <summary>
        /// Returns true if SinglePaymentUpdateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SinglePaymentUpdateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SinglePaymentUpdateResponse input)
        {
            if (input == null)
                return false;
