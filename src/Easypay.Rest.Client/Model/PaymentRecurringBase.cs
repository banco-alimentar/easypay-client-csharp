...
{
    /// <summary>
    /// PaymentRecurringBase
    /// </summary>
    [DataContract(Name = "Payment_Recurring_Base")]
    public partial class PaymentRecurringBase : IEquatable<PaymentRecurringBase>, IValidatableObject
    {
        /// <summary>
        /// Defines Currency
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRecurringBase" /> class.
        /// </summary>
        ...
        public PaymentRecurringBase(decimal maxCaptures = default(decimal), string expirationTime = default(string), CurrencyEnum? currency = CurrencyEnum.EUR, Customer customer = default(Customer), string key = default(string), double maxValue = default(double), double minValue = default(double), bool unlimitedPayments = true, FrequencyEnum? frequency = default(FrequencyEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentRecurringBase {\n");
        ...
        {
            return this.Equals(input as PaymentRecurringBase);
        }

        /// <summary>
        /// Returns true if PaymentRecurringBase instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRecurringBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRecurringBase input)
        {
            if (input == null)
                return false;
