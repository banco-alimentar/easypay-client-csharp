...
{
    /// <summary>
    /// PaymentSubscriptionMethodRequest
    /// </summary>
    [DataContract(Name = "Payment_Subscription_Method_Request")]
    public partial class PaymentSubscriptionMethodRequest : IEquatable<PaymentSubscriptionMethodRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentSubscriptionMethodRequest" /> class.
        /// </summary>
        /// <param name="method">method.</param>
        public PaymentSubscriptionMethodRequest(PaymentSubscriptionMethodAvailable method = default(PaymentSubscriptionMethodAvailable))
        {
            this.Method = method;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentSubscriptionMethodRequest {\n");
        ...
        {
            return this.Equals(input as PaymentSubscriptionMethodRequest);
        }

        /// <summary>
        /// Returns true if PaymentSubscriptionMethodRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentSubscriptionMethodRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentSubscriptionMethodRequest input)
        {
            if (input == null)
                return false;
