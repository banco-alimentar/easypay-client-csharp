...
namespace Easypay.Rest.Client.Model
{
    ...
    /// InlineResponse2015
    /// </summary>
    [DataContract(Name = "inline_response_201_5")]
    public partial class InlineResponse2015 : IEquatable<InlineResponse2015>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="responseMinimalOutputSubscription">responseMinimalOutputSubscription.</param>
        /// <param name="statusDetails">statusDetails.</param>
        public InlineResponse2015(ResponseMinimalOutputSubscription responseMinimalOutputSubscription = default(ResponseMinimalOutputSubscription), StatusDetails statusDetails = default(StatusDetails))
        {
            this.ResponseMinimalOutputSubscription = responseMinimalOutputSubscription;
        ...
        public ResponseMinimalOutputSubscription ResponseMinimalOutputSubscription { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ResponseMinimalOutputSubscription: ").Append(ResponseMinimalOutputSubscription).Append("\n");
        ...
        public bool Equals(InlineResponse2015 input)
        {
            ...
            return 
                (
                    this.ResponseMinimalOutputSubscription == input.ResponseMinimalOutputSubscription ||
                    (this.ResponseMinimalOutputSubscription != null &&
                    this.ResponseMinimalOutputSubscription.Equals(input.ResponseMinimalOutputSubscription))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ResponseMinimalOutputSubscription != null)
                    hashCode = hashCode * 59 + this.ResponseMinimalOutputSubscription.GetHashCode();
