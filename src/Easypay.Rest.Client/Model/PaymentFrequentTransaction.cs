...
namespace Easypay.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Payment_Frequent_Transaction")]
    public partial class PaymentFrequentTransaction : IEquatable<PaymentFrequentTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentFrequentTransaction" /> class.
        /// </summary>
        ...
        public PaymentFrequentTransaction(string date = default(string), Object values = default(Object), string documentNumber = default(string), Guid id = default(Guid), string key = default(string), PaymentFrequentMethodAvailable method = default(PaymentFrequentMethodAvailable))
        {
            this.Date = date;
            this.Values = values;
        ...
        public PaymentFrequentMethodAvailable Method { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentFrequentTransaction {\n");
        ...
        {
            return this.Equals(input as PaymentFrequentTransaction);
        }

        /// <summary>
        /// Returns true if PaymentFrequentTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentFrequentTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentFrequentTransaction input)
        {
            if (input == null)
                return false;
