...
{
    /// <summary>
    /// PaymentOutPaymentBase
    /// </summary>
    [DataContract(Name = "Payment_OutPayment_Base")]
    public partial class PaymentOutPaymentBase : IEquatable<PaymentOutPaymentBase>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentOutPaymentBase" /> class.
        /// </summary>
        ...
        public PaymentOutPaymentBase(Customer customer = default(Customer), string key = default(string), double value = default(double), TypeEnum? type = TypeEnum.Normal, string scheduleAt = default(string), PropertiesHasID account = default(PropertiesHasID), PropertiesHasOutAccountOutAccount outAccount = default(PropertiesHasOutAccountOutAccount))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentOutPaymentBase {\n");
        ...
        {
            return this.Equals(input as PaymentOutPaymentBase);
        }

        /// <summary>
        /// Returns true if PaymentOutPaymentBase instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentOutPaymentBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentOutPaymentBase input)
        {
            if (input == null)
                return false;
