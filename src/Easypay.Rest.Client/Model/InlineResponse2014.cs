...
namespace Easypay.Rest.Client.Model
{
    ...
    public partial class InlineResponse2014 : IEquatable<InlineResponse2014>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="checkoutManifest">checkoutManifest.</param>
        public InlineResponse2014(CheckoutManifest checkoutManifest = default(CheckoutManifest))
        {
            this.CheckoutManifest = checkoutManifest;
        }

        /// <summary>
        /// Gets or Sets CheckoutManifest
        /// </summary>
        [DataMember(Name = "Checkout_Manifest", EmitDefaultValue = false)]
        public CheckoutManifest CheckoutManifest { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CheckoutManifest: ").Append(CheckoutManifest).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineResponse2014 input)
        {
            ...
            return 
                (
                    this.CheckoutManifest == input.CheckoutManifest ||
                    (this.CheckoutManifest != null &&
                    this.CheckoutManifest.Equals(input.CheckoutManifest))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.CheckoutManifest != null)
                    hashCode = hashCode * 59 + this.CheckoutManifest.GetHashCode();
                return hashCode;
            }
        }
