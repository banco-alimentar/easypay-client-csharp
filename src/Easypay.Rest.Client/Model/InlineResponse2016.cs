...
namespace Easypay.Rest.Client.Model
{
    ...
    /// InlineResponse2016
    /// </summary>
    [DataContract(Name = "inline_response_201_6")]
    public partial class InlineResponse2016 : IEquatable<InlineResponse2016>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="responseMinimalOutputOutPayment">responseMinimalOutputOutPayment.</param>
        /// <param name="statusDetails">statusDetails.</param>
        public InlineResponse2016(ResponseMinimalOutputOutPayment responseMinimalOutputOutPayment = default(ResponseMinimalOutputOutPayment), StatusDetails statusDetails = default(StatusDetails))
        {
            this.ResponseMinimalOutputOutPayment = responseMinimalOutputOutPayment;
            this.StatusDetails = statusDetails;
        }

        /// <summary>
        /// Gets or Sets ResponseMinimalOutputOutPayment
        /// </summary>
        [DataMember(Name = "Response_MinimalOutput_OutPayment", EmitDefaultValue = false)]
        public ResponseMinimalOutputOutPayment ResponseMinimalOutputOutPayment { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ResponseMinimalOutputOutPayment: ").Append(ResponseMinimalOutputOutPayment).Append("\n");
        ...
        public bool Equals(InlineResponse2016 input)
        {
            ...
            return 
                (
                    this.ResponseMinimalOutputOutPayment == input.ResponseMinimalOutputOutPayment ||
                    (this.ResponseMinimalOutputOutPayment != null &&
                    this.ResponseMinimalOutputOutPayment.Equals(input.ResponseMinimalOutputOutPayment))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ResponseMinimalOutputOutPayment != null)
                    hashCode = hashCode * 59 + this.ResponseMinimalOutputOutPayment.GetHashCode();
