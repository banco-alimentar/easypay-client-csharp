...
{
    /// <summary>
    /// PropertiesHasOutAccountID
    /// </summary>
    [DataContract(Name = "Properties_Has_OutAccountID")]
    public partial class PropertiesHasOutAccountID : IEquatable<PropertiesHasOutAccountID>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesHasOutAccountID" /> class.
        /// </summary>
        /// <param name="outAccount">outAccount.</param>
        public PropertiesHasOutAccountID(PropertiesHasID outAccount = default(PropertiesHasID))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertiesHasOutAccountID {\n");
        ...
        {
            return this.Equals(input as PropertiesHasOutAccountID);
        }

        /// <summary>
        /// Returns true if PropertiesHasOutAccountID instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertiesHasOutAccountID to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertiesHasOutAccountID input)
        {
            if (input == null)
                return false;
