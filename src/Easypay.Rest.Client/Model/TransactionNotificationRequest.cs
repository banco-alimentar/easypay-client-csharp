...
namespace Easypay.Rest.Client.Model
{
    ...
    public partial class TransactionNotificationRequest : IEquatable<TransactionNotificationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TransactionNotificationRequest);
        }

        /// <summary>
        /// Returns true if TransactionNotificationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionNotificationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionNotificationRequest input)
        {
            if (input == null)
                return false;
