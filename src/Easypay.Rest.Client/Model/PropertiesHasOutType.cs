...
{
    /// <summary>
    /// PropertiesHasOutType
    /// </summary>
    [DataContract(Name = "Properties_Has_OutType")]
    public partial class PropertiesHasOutType : IEquatable<PropertiesHasOutType>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesHasOutType" /> class.
        /// </summary>
        /// <param name="type">Optional - only applicable to method transfer (default to TypeEnum.Normal).</param>
        public PropertiesHasOutType(TypeEnum? type = TypeEnum.Normal)
        {
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertiesHasOutType {\n");
        ...
        {
            return this.Equals(input as PropertiesHasOutType);
        }

        /// <summary>
        /// Returns true if PropertiesHasOutType instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertiesHasOutType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertiesHasOutType input)
        {
            if (input == null)
                return false;
