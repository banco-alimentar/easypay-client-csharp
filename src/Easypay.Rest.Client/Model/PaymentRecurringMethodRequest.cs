...
{
    /// <summary>
    /// PaymentRecurringMethodRequest
    /// </summary>
    [DataContract(Name = "Payment_Recurring_Method_Request")]
    public partial class PaymentRecurringMethodRequest : IEquatable<PaymentRecurringMethodRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRecurringMethodRequest" /> class.
        /// </summary>
        /// <param name="method">method.</param>
        public PaymentRecurringMethodRequest(PaymentRecurringMethodAvailable method = default(PaymentRecurringMethodAvailable))
        {
            this.Method = method;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentRecurringMethodRequest {\n");
        ...
        {
            return this.Equals(input as PaymentRecurringMethodRequest);
        }

        /// <summary>
        /// Returns true if PaymentRecurringMethodRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRecurringMethodRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRecurringMethodRequest input)
        {
            if (input == null)
                return false;
