...
{
    /// <summary>
    /// ReportDetailsFullDateRange
    /// </summary>
    [DataContract(Name = "Report_DetailsFull_date_range")]
    public partial class ReportDetailsFullDateRange : IEquatable<ReportDetailsFullDateRange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportDetailsFullDateRange" /> class.
        /// </summary>
        /// <param name="init">Init data can&#39;t be older than 1 or 2 years.</param>
        /// <param name="end">If not set, this field should be evaluated as the moment of the request.</param>
        public ReportDetailsFullDateRange(string init = default(string), string end = default(string))
        {
            this.Init = init;
            this.End = end;
        }
        ...
        /// <summary>
        /// Init data can&#39;t be older than 1 or 2 years
        /// </summary>
        /// <value>Init data can&#39;t be older than 1 or 2 years</value>
        [DataMember(Name = "init", EmitDefaultValue = false)]
        public string Init { get; set; }

        /// <summary>
        /// If not set, this field should be evaluated as the moment of the request
        /// </summary>
        /// <value>If not set, this field should be evaluated as the moment of the request</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReportDetailsFullDateRange {\n");
        ...
        {
            return this.Equals(input as ReportDetailsFullDateRange);
        }

        /// <summary>
        /// Returns true if ReportDetailsFullDateRange instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportDetailsFullDateRange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportDetailsFullDateRange input)
        {
            if (input == null)
                return false;
