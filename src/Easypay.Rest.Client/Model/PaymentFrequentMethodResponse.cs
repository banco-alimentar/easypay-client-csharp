...
namespace Easypay.Rest.Client.Model
{
    ...
    public partial class PaymentFrequentMethodResponse : IEquatable<PaymentFrequentMethodResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PaymentFrequentMethodResponse);
        }

        /// <summary>
        /// Returns true if PaymentFrequentMethodResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentFrequentMethodResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentFrequentMethodResponse input)
        {
            if (input == null)
                return false;
