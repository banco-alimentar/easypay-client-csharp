...
{
    /// <summary>
    /// PaymentOutPaymentMethodRequest
    /// </summary>
    [DataContract(Name = "Payment_OutPayment_Method_Request")]
    public partial class PaymentOutPaymentMethodRequest : IEquatable<PaymentOutPaymentMethodRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentOutPaymentMethodRequest" /> class.
        /// </summary>
        /// <param name="method">method.</param>
        public PaymentOutPaymentMethodRequest(PaymentOutPaymentMethodAvailable method = default(PaymentOutPaymentMethodAvailable))
        {
            this.Method = method;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentOutPaymentMethodRequest {\n");
        ...
        {
            return this.Equals(input as PaymentOutPaymentMethodRequest);
        }

        /// <summary>
        /// Returns true if PaymentOutPaymentMethodRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentOutPaymentMethodRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentOutPaymentMethodRequest input)
        {
            if (input == null)
                return false;
