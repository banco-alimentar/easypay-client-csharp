...
{
    /// <summary>
    /// PaymentSubscriptionBase
    /// </summary>
    [DataContract(Name = "Payment_Subscription_Base")]
    public partial class PaymentSubscriptionBase : IEquatable<PaymentSubscriptionBase>, IValidatableObject
    {
        /// <summary>
        /// Defines Currency
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentSubscriptionBase" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentSubscriptionBase {\n");
        ...
        {
            return this.Equals(input as PaymentSubscriptionBase);
        }

        /// <summary>
        /// Returns true if PaymentSubscriptionBase instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentSubscriptionBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentSubscriptionBase input)
        {
            if (input == null)
                return false;
