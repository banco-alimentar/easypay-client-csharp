...
namespace Easypay.Rest.Client.Model
{
    ...
    /// AuthorisationBase
    /// </summary>
    [DataContract(Name = "Authorisation_Base")]
    public partial class AuthorisationBase : IEquatable<AuthorisationBase>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorisationBase" /> class.
        /// </summary>
        ...
        public AuthorisationBase(StatusEnum? status = default(StatusEnum?), string message = default(string), CurrencyEnum? currency = CurrencyEnum.EUR, Customer customer = default(Customer), string key = default(string))
        {
            this.Status = status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthorisationBase {\n");
        ...
        {
            return this.Equals(input as AuthorisationBase);
        }

        /// <summary>
        /// Returns true if AuthorisationBase instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthorisationBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthorisationBase input)
        {
            if (input == null)
                return false;
