...
{
    /// <summary>
    /// SinglePaymentUpdateRequestCustomer
    /// </summary>
    [DataContract(Name = "SinglePaymentUpdateRequest_customer")]
    public partial class SinglePaymentUpdateRequestCustomer : IEquatable<SinglePaymentUpdateRequestCustomer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SinglePaymentUpdateRequestCustomer" /> class.
        /// </summary>
        ...
        public SinglePaymentUpdateRequestCustomer(Guid id = default(Guid), string name = default(string), string email = default(string), string phone = default(string), string phoneIndicative = "+351", string fiscalNumber = default(string), string key = default(string), string language = "PT")
        {
            this.Id = id;
            this.Name = name;
            this.Email = email;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SinglePaymentUpdateRequestCustomer {\n");
        ...
        {
            return this.Equals(input as SinglePaymentUpdateRequestCustomer);
        }

        /// <summary>
        /// Returns true if SinglePaymentUpdateRequestCustomer instances are equal
        /// </summary>
        /// <param name="input">Instance of SinglePaymentUpdateRequestCustomer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SinglePaymentUpdateRequestCustomer input)
        {
            if (input == null)
                return false;
