...
namespace Easypay.Rest.Client.Model
{
    ...
    public partial class InlineResponse200 : IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        public InlineResponse200(PropertiesHasListMetaData propertiesHasListMetaData = default(PropertiesHasListMetaData))
        {
        ...
        public bool Equals(InlineResponse200 input)
        {
            ...
            return 
                (
                    this.PropertiesHasListMetaData == input.PropertiesHasListMetaData ||
                    (this.PropertiesHasListMetaData != null &&
                    this.PropertiesHasListMetaData.Equals(input.PropertiesHasListMetaData))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.PropertiesHasListMetaData != null)
                    hashCode = hashCode * 59 + this.PropertiesHasListMetaData.GetHashCode();
                return hashCode;
            }
        }
