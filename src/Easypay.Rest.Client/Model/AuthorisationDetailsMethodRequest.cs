...
{
    /// <summary>
    /// AuthorisationDetailsMethodRequest
    /// </summary>
    [DataContract(Name = "Authorisation_Details_Method_Request")]
    public partial class AuthorisationDetailsMethodRequest : IEquatable<AuthorisationDetailsMethodRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorisationDetailsMethodRequest" /> class.
        /// </summary>
        /// <param name="method">method.</param>
        public AuthorisationDetailsMethodRequest(AuthorisationDetailsMethodAvailable method = default(AuthorisationDetailsMethodAvailable))
        {
            this.Method = method;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthorisationDetailsMethodRequest {\n");
        ...
        {
            return this.Equals(input as AuthorisationDetailsMethodRequest);
        }

        /// <summary>
        /// Returns true if AuthorisationDetailsMethodRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthorisationDetailsMethodRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthorisationDetailsMethodRequest input)
        {
            if (input == null)
                return false;
