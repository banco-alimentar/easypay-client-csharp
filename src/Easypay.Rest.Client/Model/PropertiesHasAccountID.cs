...
namespace Easypay.Rest.Client.Model
{
    ...
    public partial class PropertiesHasAccountID : IEquatable<PropertiesHasAccountID>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PropertiesHasAccountID);
        }

        /// <summary>
        /// Returns true if PropertiesHasAccountID instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertiesHasAccountID to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertiesHasAccountID input)
        {
            if (input == null)
                return false;
