...
{
    /// <summary>
    /// PaymentRecurringPatchable
    /// </summary>
    [DataContract(Name = "Payment_Recurring_Patchable")]
    public partial class PaymentRecurringPatchable : IEquatable<PaymentRecurringPatchable>, IValidatableObject
    {
        /// <summary>
        /// Defines Currency
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRecurringPatchable" /> class.
        /// </summary>
        ...
        public PaymentRecurringPatchable(string expirationTime = default(string), CurrencyEnum? currency = CurrencyEnum.EUR, Customer customer = default(Customer), string key = default(string), double value = default(double), FrequencyEnum? frequency = default(FrequencyEnum?), decimal maxCaptures = default(decimal), string startTime = default(string), bool failover = false, bool captureNow = false, decimal retries = default(decimal), PaymentSubscriptionMethodResponseMethod method = default(PaymentSubscriptionMethodResponseMethod), PropertiesHasID account = default(PropertiesHasID))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentRecurringPatchable {\n");
        ...
        {
            return this.Equals(input as PaymentRecurringPatchable);
        }

        /// <summary>
        /// Returns true if PaymentRecurringPatchable instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRecurringPatchable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRecurringPatchable input)
        {
            if (input == null)
                return false;
