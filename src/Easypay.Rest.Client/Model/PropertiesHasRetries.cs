...
{
    /// <summary>
    /// PropertiesHasRetries
    /// </summary>
    [DataContract(Name = "Properties_Has_Retries")]
    public partial class PropertiesHasRetries : IEquatable<PropertiesHasRetries>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesHasRetries" /> class.
        /// </summary>
        ...
        public PropertiesHasRetries(decimal retries = default(decimal))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertiesHasRetries {\n");
        ...
        {
            return this.Equals(input as PropertiesHasRetries);
        }

        /// <summary>
        /// Returns true if PropertiesHasRetries instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertiesHasRetries to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertiesHasRetries input)
        {
            if (input == null)
                return false;
