...
namespace Easypay.Rest.Client.Model
{
    ...
    public partial class PaymentFrequentMethodResponseMethod : IEquatable<PaymentFrequentMethodResponseMethod>, IValidatableObject
    {
        /// <summary>
        ...
        public PaymentFrequentMethodResponseMethod(PaymentFrequentMethodAvailable type = default(PaymentFrequentMethodAvailable), SddMandate sddMandate = default(SddMandate))
        {
            this.Type = type;
        ...
        {
            return this.Equals(input as PaymentFrequentMethodResponseMethod);
        }

        /// <summary>
        /// Returns true if PaymentFrequentMethodResponseMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentFrequentMethodResponseMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentFrequentMethodResponseMethod input)
        {
            if (input == null)
                return false;
