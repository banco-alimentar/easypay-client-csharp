...
namespace Easypay.Rest.Client.Model
{
    ...
    public partial class InlineResponse2005 : IEquatable<InlineResponse2005>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="authorisationStatus">authorisationStatus.</param>
        /// <param name="propertiesHasDescriptive">propertiesHasDescriptive.</param>
        /// <param name="propertiesHasID">propertiesHasID.</param>
        public InlineResponse2005(AuthorisationStatus authorisationStatus = default(AuthorisationStatus), PropertiesHasDescriptive propertiesHasDescriptive = default(PropertiesHasDescriptive), PropertiesHasID propertiesHasID = default(PropertiesHasID))
        {
        ...
        /// </summary>
        [DataMember(Name = "Authorisation_Status", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AuthorisationStatus: ").Append(AuthorisationStatus).Append("\n");
        ...
        public bool Equals(InlineResponse2005 input)
        {
            ...
            return 
                (
                    this.AuthorisationStatus == input.AuthorisationStatus ||
                    (this.AuthorisationStatus != null &&
                    this.AuthorisationStatus.Equals(input.AuthorisationStatus))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AuthorisationStatus != null)
                    hashCode = hashCode * 59 + this.AuthorisationStatus.GetHashCode();
