...
{
    /// <summary>
    /// AuthorisationAuthorisationMethodPropertiesStatus
    /// </summary>
    [DataContract(Name = "Authorisation_AuthorisationMethod_Properties_Status")]
    public partial class AuthorisationAuthorisationMethodPropertiesStatus : IEquatable<AuthorisationAuthorisationMethodPropertiesStatus>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorisationAuthorisationMethodPropertiesStatus" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public AuthorisationAuthorisationMethodPropertiesStatus(StatusEnum? status = default(StatusEnum?))
        {
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthorisationAuthorisationMethodPropertiesStatus {\n");
        ...
        {
            return this.Equals(input as AuthorisationAuthorisationMethodPropertiesStatus);
        }

        /// <summary>
        /// Returns true if AuthorisationAuthorisationMethodPropertiesStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthorisationAuthorisationMethodPropertiesStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthorisationAuthorisationMethodPropertiesStatus input)
        {
            if (input == null)
                return false;
