...
namespace BancoAlimentar.AlimentaEstaIdeia.easypay.Model
{
    ...
    public partial class PaymentMethod : IEquatable<PaymentMethod>, IValidatableObject
    {
        ...
        public PaymentMethod(int entity = default(int), string reference = default(string), string url = default(string), string lastFour = default(string), string cardType = default(string), string expirationDate = default(string), StatusEnum status = default(StatusEnum))
        {
            this.Status = status;
            this.Entity = entity;
