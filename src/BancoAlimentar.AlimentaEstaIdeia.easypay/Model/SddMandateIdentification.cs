...
{
    /// <summary>
    /// SddMandateIdentification
    /// </summary>
    [DataContract(Name = "SddMandate_Identification")]
    public partial class SddMandateIdentification : IEquatable<SddMandateIdentification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SddMandateIdentification" /> class.
        /// </summary>
        /// <param name="id">Optional - unique identifier from previous created mandates.</param>
        public SddMandateIdentification(string id = default(string))
        {
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SddMandateIdentification {\n");
        ...
        {
            return this.Equals(input as SddMandateIdentification);
        }

        /// <summary>
        /// Returns true if SddMandateIdentification instances are equal
        /// </summary>
        /// <param name="input">Instance of SddMandateIdentification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SddMandateIdentification input)
        {
            if (input == null)
                return false;
